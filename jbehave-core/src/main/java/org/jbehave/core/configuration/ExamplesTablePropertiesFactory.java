...
//		Map<String, String> propertiesMap = parseProperties(propertiesAsString);
		return new ExamplesTableProperties(parseProperties(propertiesAsString), propertiesAsString, defaultHeaderSeparator, defaultValueSeparator, defaultIgnorableSeparator);
	}
